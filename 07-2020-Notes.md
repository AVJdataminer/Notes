...
We apply the jarque_bera and normal tests help indicate to us if the Boxcox transformation resulted in a normal distribution. As with all statistical testing the results can be considered significant if the p
...
7. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NzY1MTg4NjYsLTE3Njc3NjMxOTgsLT
