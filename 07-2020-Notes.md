...
## 16JUL
### NLP project with Shovon
[https://www.machinelearningplus.com/nlp/gensim-tutorial/](https://www.machinelearningplus.com/nlp/gensim-tutorial/)

Potential Resume code

https://github.com/outsideken/Resumes

  

https://github.com/mandub/Resumes-Filtering

  

[Data Science Keyword resume matcher, includes a PDF reader](https://github.com/venkarafa/Resume-Screening-NLP)

  

[Data Science Resumes & Job posting data set and notebook](https://github.com/JanJanJan2018/DataScienceJobsResumes)

  

[Example of using cosine similarity for job and resume matching](https://github.com/superhen/Automated-Job-Resume-Matching-Solution)

  

[Another example reading in PDf's](https://github.com/binoydutt/Resume-Job-Description-Matching)

### SB Project Interview with Ruoqi (Rosie)
Music Genre Classification
FMA Small dataset
mp3 data of 30 seconds in 8 genres
wav files converted to images
could combine object detection with classification of images

### Thinkful 
Update SQL Alchemy checkpoint - [Github Issue](https://github.com/Thinkful-Ed/data-analytics-bootcamp/issues/1264) 
The goal is to convert SQL Alchemy content to Pandas from SQL usage
1. Review Pandas SQL documentation
2. 

[Working notes doc](https://docs.google.com/document/d/1Y3mkwfd-WEb8atdM1AEU3LwaPw3jt5e2DfnNDJoJKEM/edit)

Discussed the low DA completion
- developed a digital literacy test now
- provide income share and other incentives.
- time between checkpoint completion appears to be the most important in determining if someone will complete or drop out.

- [ ] Start on Github Api project to get issue content


### Getting SP interview contacts from Google Calendar
Use api program with seperate python scripts

- [x] need to create a seperate program that pulls only springboard eventsbased on calendar id,
- [x] need to fix format to ouput simple comma seperated list of emails 
- [x] Make format to match import to google contacts with label
- [ ] Check list already sent triplebyte link for duplicates and resend email.
- [ ]  May use send grid in airtable to share triplebyte email
- [ ]  Create a program to download all resumes into ds-resume folder for other hiring app project

### SB Project Interview with Julia 
Title: Object detection to remove text from construction images
- pascalvoc.py for object detection verification with bounding boxes
- deep learning course at Harvard could be good 
- [ ] review ML/DL courses at Harvard


### Professional dev
[Alan Turing Institute Data Science Study Group](https://www.turing.ac.uk/events/data-study-group-september-2020)
Application due 27 July
[About applying](https://www.turing.ac.uk/blog/how-write-great-data-study-group-application)


## 15JUL
### Thinkful Meeting
Now we must add an archived copy of each assessment
### Meeting With Shovon
...
7. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNTgwNzU5NjUsOTU0Njc1NDk0LDExOT
Q1ODc4MCwtMTYyNjY4NDgyOCwyODU4OTU3ODUsLTEyNzYxMDk2
MzEsLTQwNTg4ODUyLC0yMDc1NDM5OTc3LDE3NjA3NjQ1MzMsLT
QyMTA5Mzc4NSw4MTA1MzgwODQsLTEwMDIzMTgwMjcsMTI1ODEz
OTk0MCwtMTA1NzY0NDE2NSw2NTY5MTQyMzcsLTExOTUwOTg4NT
EsMTMzNTAxNTc4NSwtMjA3NzA5MjQ1OCwtMTc2Nzc2MzE5OCwt
NTc4Mjc3MDY5XX0=
-->