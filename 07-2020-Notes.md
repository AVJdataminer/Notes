...
When in preview mode the `test_submission.py` is visible and the `test_solution.py` is not visible.
...
7. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg5NDc5MTU2MSwxMzUzMjMyODEzLC0zOT
AxNjgzNjMsLTEwODIzMjY4MTksLTczNTExNjcwMyw4MDg0NTQx
MjQsMTkyODQ2MDYyNCw1MTI0MTM2MiwxMTE4NTY3Nzc0XX0=
-->