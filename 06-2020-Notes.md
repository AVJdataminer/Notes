...
Call with Rose
- Lue Ellen dogs
- Toony tails in Manhattan
- houndsman puppymill
- blind in 1 blind eye
- Kova - resilience 
- 
Training with Know thy dog
- flag on the pole outdoor arena
- Tina trains horses
- 
Working for American Associate for the Advancement of Science since January
Ethics and Human rights in the sciences.
Susan friend brought her on
Jessica human right lawyer
world wide survey
demographics
influences, ethics, influences on ethics
response rate is 3%, 4789 obs, 19 questions, during the last three years how often have you considered



# 25 Jun
Checkpoint: [https://courses.thinkful.com/dsbc-classifications-v1/checkpoint/2](https://courses.thinkful.com/dsbc-classifications-v1/checkpoint/2)

# 24 Jun
Set up with VPN for community health partners
OPen VMware client
a.johnson
Aj2020shift123

Need to ask if Allyson is comfortable with me billing the whole month of June given all of the previous time I have spent in getting set up with them?

[Shorts from Peter Millar](https://www.petermillar.com/p/solid-performance-polo-ms20ek500s.html)


# 23 Jun
## Thinkful
Qualified.io - Q & A challenges --> quiz like but still allows for some auto graidng with free text and Multiple choice.


# 22 Jun 
[Mock Technical Interviews ~$225/each](https://interviewing.io/)

Answer about when to work with a mentee or not:
However, this honestly depends on the mentor and what they expect during a mentorship. For me as an example I focus less on the theoretical / mathematical aptitude and more on the hands-on. I want them to have decent coding experience as the math and theory can be learned in tandem. For me, a good signal is whether the mentee has decent coding experience, has dabbled with some deep learning packages and has played with a lot of the scientific stack in Python. The reason why I prefer this is that I had a mentee who knew a lot of the mathematical theory and was not proficient in any languages so we spent more time debugging his/her code and getting it deployed. I did drop the mentee eventually because of their attitude and motivation, but this is what I prefer.What I would impart on you is to picture yourself working with this mentee where you're in a senior capacity and they in a junior capacity at the same company you're at. After you talk to the mentee, can you see yourself working with this person? How much guidance are they expecting from you vs. how independent they work? What are the some of their weaknesses and can you tolerate those weaknesses? What are some of their strengths and will this clash with how you work?... and so on.Suffice it to say, there's no standard criteria to use but what I usually say to mentors is to picture the above work scenario and if you can handle working alongside them where they're in a junior role, that's enough for me.Also, don't be afraid to exercise the trial option. It's there so that you can find the time to figure out how well you two work together. If at the end of the trial you see that there are obvious clashes, you can walk away with no ramifications. This was put into place because there have been cases where mentors and mentees clash and end up dropping the mentorship... and this is unfortunately a manual process. This trial option allows the mutual dissolving of the mentorship to be more streamlined. I've had my fair share of drops (I've had 5 that I've had to drop or they have cancelled... and this is even with what I used above to vet a candidate... you just don't know until you get into the mentorship)), so this trial option is extremely useful.
...
Wife is pregnant and due in 3 weeks
He will send project by Monday for review.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjc5MjY2NTE2LC0xNDA2NjA3MTE4LC03Nz
Y5Nzk2NDAsMTUzNTkzODI0NiwtMTI4OTA1MzY1MywtMTAwOTAw
ODQzLDExNzExNDQ0NzAsLTE0MTgyMjY4OTQsNDEwNjQ1MDk0LD
EwNzA3MzkxMzUsMTQ5ODg4NzUwMywtOTQ3NzY0NTk5LDE3MTA2
MDIwNjEsLTIwNjE2MDQ3OTYsMjY5Njg4MTI3LC04NjIyNjc2Nz
EsMzE4OTYzNjEyLC0xMDA4MTYyNjIyLC0xNTM3MjU4NTE4LDEw
MzI4ODk4NDVdfQ==
-->